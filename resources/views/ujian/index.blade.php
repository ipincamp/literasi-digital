...
<div class="container">
    ...
    <form method="POST" action="{{ route('ujian.submit') }}">
        ...
        <div class="card shadow border-0 mb-4 bg-white">
            <div class="card-body">
                ...
                <div class="mb-3 text-center">
                    <img src="{{ asset('storage/' . $soal->teslet_gambar) }}"
                ...
                @php
                $opsiDasar = ['a', 'b', 'c', 'd'];
                $opsiTambahan = $soal->pilihan_e ? ['e'] : []; // hanya tambahkan e jika tidak kosong
                $semuaOpsi = array_merge($opsiDasar, $opsiTambahan);
                @endphp
        ...
        <div class="d-flex justify-content-between">
            @if($current > 1)
            <a href="{{ route('ujian.index', ['nomor' => $current - 1]) }}" class="btn btn-secondary">
                Kembali
            </a>
            @else
            <span></span>
