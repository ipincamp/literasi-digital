...
@section('content')
<div class="container">
    <h4 class="mb-4">Domain Kognitif</h4>
    ...
    <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modalTambah">
        <i class="bi bi-plus-circle"></i> Tambah Domain
    </button>

    <div class="table-responsive">
        <table id="domainTable" class="table table-bordered table-striped align-middle">
            ...
            <tbody>
                ...
                <div class="modal fade" id="modalEdit{{ $item->id }}" tabindex="-1">
                    <div class="modal-dialog">
                        <form method="POST" action="{{ route('domain.update', $item->id) }}">
                            @csrf
                            @method('PUT')
                ...
                <div class="modal fade" id="modalHapus{{ $item->id }}" tabindex="-1">
                    <div class="modal-dialog">
                        <form method="POST" action="{{ route('domain.destroy', $item->id) }}">
                            @csrf
                            @method('DELETE')
                            <div class="modal-content">
                                <div class="modal-header bg-danger text-white">
                                    <h5 class="modal-title">Hapus Domain</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body">
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1">
        <div class="modal-dialog">
            <form method="POST" action="{{ route('domain.store') }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Domain</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
